...
2. Training mode - When starting a game, players can select to be in "training mode".  In training mode, two things will hapen: (a) (b) a value is shown to the player every time they have a chance to bet - the pot odds ( https://en.wikipedia.org/wiki/Pot_odds ).
